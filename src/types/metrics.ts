...
export interface CategoryMetrics {
  ...
  // Top/bottom questions (by evidence depth)
  top_questions: Array<{
    question_id: string;
    question_text: string;
...
/**
 * Radar chart dimensions for company comparison (4 dimensions)
 */
...
export interface CompanyMetrics {
  ...
  // Radar chart dimensions (4 dimensions)
...
export interface CrossCompanyMetrics {
  // Question performance across companies (ranked by evidence depth)
  ...
  // Company rankings (by total snippets)
  ...
  // Category performance (by average evidence depth)
